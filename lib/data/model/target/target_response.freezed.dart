...
TargetResponse _$TargetResponseFromJson(Map<String, dynamic> json) {
  return _TargetResponse.fromJson(json);
}
...
mixin _$TargetResponse {
  ...
  @JsonKey(ignore: true)
  $TargetResponseCopyWith<TargetResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TargetResponseCopyWith<$Res> {
  factory $TargetResponseCopyWith(
          TargetResponse value, $Res Function(TargetResponse) then) =
      _$TargetResponseCopyWithImpl<$Res, TargetResponse>;
  @useResult
  $Res call(
      {String? title,
      String? description,
...
/// @nodoc
class _$TargetResponseCopyWithImpl<$Res, $Val extends TargetResponse>
    implements $TargetResponseCopyWith<$Res> {
  _$TargetResponseCopyWithImpl(this._value, this._then);
...
abstract class _TargetResponse implements TargetResponse {
