...
class _$ClaimResponseImpl implements _ClaimResponse {
  ...
  @override
  String toString() {
    return 'ClaimResponse(name: $name, description: $description, department: $department, tenantId: $tenantId, id: $id, createdBy: $createdBy, createdDate: $createdDate)';
  }
...
abstract class _ClaimResponse implements ClaimResponse {
  factory _ClaimResponse(
      ...
      String? id,
      String? createdBy,
      String? createdDate}) = _$ClaimResponseImpl;
