...
import 'calendar/components/calendar_event_item.dart';
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            ...
            BlocBuilder<EventCubit, EventState>(
              buildWhen: (previous, current) {
                return current is EventGetEventByDateSuccessState ||
                    current is EventGetEventByDateFailedState;
              },
              builder: (context, state) {
                if (state is EventGetEventByDateSuccessState) {
